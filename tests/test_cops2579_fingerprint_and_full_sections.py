...
def test_package_sections_stores_more_than_ten():
    ...
    _, stored, _, _, _, _, _, _ = m._package_sections(sections)
...
def test_package_sections_returns_fingerprint():
    ...
    _, _, _, _, fp, _, _, _ = m._package_sections(sections)
...
def test_package_sections_fingerprint_stable_across_two_apps_same_change():
    ...
    _, _, _, _, fp_a, _, _, _ = m._package_sections(app_a_sections)
    _, _, _, _, fp_b, _, _, _ = m._package_sections(app_b_sections)
    assert fp_a == fp_b
...
def test_package_sections_fingerprint_differs_for_different_apps():
    ...
    _, _, _, _, fp_a, _, _, _ = m._package_sections(app_a_sections)
    _, _, _, _, fp_c, _, _, _ = m._package_sections(app_c_sections)
    assert fp_a != fp_c
