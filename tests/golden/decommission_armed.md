...
Even a full cascade leaves the content backup bucket (`deletion-policy: abandon`, never purged) and some namespace-level leftovers behind. Full procedure: see `acme-components` `documentation/`.
