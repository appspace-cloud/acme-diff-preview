...
- ⬆️ **5 environment(s) jumping** `image`: `appspace-ms:2603.0.0` → `appspace-ms:2603.1.0`: pv-fleet-00, pv-fleet-01, pv-fleet-02, pv-fleet-03, pv-fleet-04
...
---
**Status:** ⚠️ 5 resource(s) will change
